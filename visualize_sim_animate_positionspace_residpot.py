...
loadfile = 'simulation_linrelease_residpot=2k_rotframe_relonly_psi0=ground_10k,763,200u.npy'
totalAnimTime = 20      # seconds
save = False
...
line5, = ax2.plot([], [], label='V_resid', color='k')
...
def init():
    ...
    line3.set_data([], [])
    line4.set_data([], [])
    line5.set_data(phi, 0.5*V1*(np.cos(2*phi+phi1)+1))
...
def animate(i):
    ...
    return line1, line2, line3, line4, line5, txt_time, txt_V0, txt_frot
