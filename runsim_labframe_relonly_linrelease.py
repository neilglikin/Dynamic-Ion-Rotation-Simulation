# File ionsim_runsimulation_releaseonly.py
...
trel   = 50e-3
thold2 = 0
savefile = 'time_evolution_releaseonly_5k,0,50m'

# Solve for time evolution
(c, psi, phi, tvals) = ion.time_evolution_releaseonly(V0i, frotf, trel, thold2)
(V0_vals, frot_vals, theta_vals) = ion.V0_frot_theta_fun_general(tvals, V0i, frotf, 0, 0, trel)
